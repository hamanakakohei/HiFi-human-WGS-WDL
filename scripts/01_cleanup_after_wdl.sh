...
####    #####ls -l cromwell-executions/humanwgs_family_01/${uuid}/call-upstream/shard-*/upstream/*/call-merge_hifi_fail_bams/inputs/*/${sample_id}.${movie_id}.fail_reads.*GRCh38.aligned.bam
...
for movie_id in ${arr[@]}; do
    ...
    rm cromwell-executions/humanwgs_family_01/${uuid}/call-upstream/shard-*/upstream/*/call-merge_hifi_fail_bams/inputs/*/${sample_id}.${movie_id}.fail_reads.*GRCh38.aligned.bam
