...
#import "upstream/upstream.edit4cohort.wdl" as Upstream
...
import "tertiary/tertiary.edit4cohort.small_variants_only.wdl" as TertiaryAnalysis
...
workflow humanwgs_family {
  ...
  input {
    Downstream_outs downstream # EDITED
    Family family
  ...
  scatter (sample in family.samples) {
    ...
    Array[String] sample_metadata = [
      ...
      pedigree_sex[sample.inferred_sex], # EDITED
